...
$color = "";
    ...
    {
        $color = "RED";
        $warning = "Username atau password anda salah";
    }
    else if(isset($_GET['logout']))
    {
        $color = "BLUE";
        $warning = "Anda sudah logout, terimakasih";
    }
    else if(isset($_GET['empty']))
    {
        $color = "RED";
        $warning = "Username atau password belum terisi";
    }
    else if(isset($_GET['registered']))
    {
        $color = "BLUE";
        $warning = "User Registered Sucessfully Please Try to LOGIN";
    }
    else
    {
        $warning = "";
