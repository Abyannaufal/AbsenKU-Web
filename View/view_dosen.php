          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
              ...
              <form id="LogOut" action = "proses.php" method = "POST">
                ...
                <a class="nav-link js-scroll-trigger" href="#" onclick="document.getElementById('LogOut').submit();"><img src="logouts.png"/></span></a>
              </form>
              </li>
              ...
              <div id="collapse_<?php echo $id?>" class="collapse" data-parent="#accordion_<?php echo $id?>">
                <div class="card-body">
                 ...
                 <form method="POST" action="proses.php">
                    <input type="hidden" name="id" value="<?php echo $kode_kelas?>"/>
                    <textarea placeholder="Enter Text..." style="width:100%;" id="pengumuman" name="pengumuman"></textarea>
                    <input type="submit" name="submit_pengumuman" value = "Submit"/>
                    <input type="submit" name="reset_pengumuman" value = "Reset"/>
                </form>
                </div>
              </div>
              <div class="card-footer">
                Pengumuman yang ditampilkan:<br>
                <?php echo $kelas['pengumuman'];?>
              </div>
            </div>
          </div>
          <br>
